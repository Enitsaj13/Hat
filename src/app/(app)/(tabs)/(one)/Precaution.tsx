    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.occupationalTitleContainer}>
                <Text style={styles.title}>{i18n.t("U16", {
            ...
            <View style={styles.actionTitleContainer}>
                <Text style={styles.title}>{i18n.t("AE8", {
                    defaultValue: "ACTION"
                })}</Text>
            </View>
            <View style={styles.actionContainer}>
                <View style={styles.actionListContainer}>
                    <Text style={styles.actionTitle}>{i18n.t("AF7", {
            ...
            <View style={styles.actionContainer}>
                <View style={styles.actionListContainer}>
                    <Text style={styles.actionTitle}>{i18n.t("AF8", {
            ...
            <View style={styles.actionContainer}>
                <View style={styles.actionListContainer}>
                    <Text style={styles.actionTitle}>{i18n.t("AF9", {
            ...
            <View style={styles.actionTitleContainer}>
                <Text style={styles.title}>{i18n.t("OPF1", {
